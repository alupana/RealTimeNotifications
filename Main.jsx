                ...
                <div className="offcanvas offcanvas-end" id="EditLoggedInUser">
                  ...
                  {editStatus === 'error' && (
                    <div class="alert alert-danger mt-5 m-4" >
                      Failed to update UserDetials. Please try again.
                    </div>
                  )}
                </div>
              </div>
                  ...
                  <div style={{ fontSize: "15px" }} className="mt-5">
                    <table className="table table-borderless mt-3" >
                      <tbody>
                        ...
                        <tr >
                          <td>
                            <select className='form-select' onClick={(e) => setConversationId(e.target.selectedOptions[0] && e.target.selectedOptions[0].value)}>
